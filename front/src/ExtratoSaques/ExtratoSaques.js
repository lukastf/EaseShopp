...
import pesquisaExtrato from './pesquisaExtratoSaques';
import getExtrato from './getExtratoSaques';

class ExtratoSaques extends React.Component {
    ...
    render(){
        return(
            <div className="row col-12">
                ...
                <h1 className={"col-6 mt-5 " + styles.titulo} > Extrato dos Resgates </h1>
