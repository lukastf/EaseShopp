...
class Indicacoes {
  ...
  static getPagination = async (req, resp) => {
    ...
    let response = await dm.getManyPagination("indicacoes", req.params);
  ...
  static get = async (req, resp) => {
    ...
    let response = await dm.getMany("indicacoes", req.params);
  ...
  static delete = async (req, resp) => {
    ...
    let response = await dm.deleteOne("indicacoes", req.params);
